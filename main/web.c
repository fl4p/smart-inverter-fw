...
static esp_err_t allow_cors_handler(httpd_req_t *req)
{
    httpd_resp_set_status(req, HTTPD_204);
    httpd_resp_set_hdr(req, "Access-Control-Allow-Methods", "POST, GET, OPTIONS, DELETE");
    httpd_resp_set_hdr(req, "Access-Control-Allow-Headers", "content-type, content-length, x-csrftoken, authentication");
...
esp_err_t start_rest_server(const char *base_path)
{
    ...
    httpd_uri_t dcdc_options_uri = {
            .uri = "/api/v1/dcdc",
            .method = HTTP_OPTIONS,
            .handler = allow_cors_handler,
            .user_ctx = rest_context
    };
    httpd_register_uri_handler(server, &dcdc_options_uri);
